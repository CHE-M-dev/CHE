...
export function CreateCompanyForm() {
  ...
  return (
    <div className="mx-auto max-w-sm space-y-6 rounded-xl border border-neutral-200 bg-white p-8 shadow-sm">
      <div className="space-y-1 text-center">
        <h1 className="text-lg font-semibold text-neutral-900">Set up your company</h1>
